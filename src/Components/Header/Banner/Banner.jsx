...
const Banner = () => {
  ...
  //   <h1 className="absolute text-center bottom-[40%] w-full mt-10 lg:mt-24 text-2xl md:text-3xl lg:text-5xl  text-[#0B0B0B] font-bold">
  ...
  //   <div className="searchbar absolute left-20 right-16 bottom-[25%] mx-auto w-full lg:w-[60%] ml-30  px-20">
  //     <form>
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url(src/assets/How-to-Donate-on-Giving-Tuesday.webp)",
      }}
    >
